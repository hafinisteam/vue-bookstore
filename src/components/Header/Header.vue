  ...
  <header class="site-header relative">
    <div class="topbar border-bottom">
      <div class="container-fluid px-2 px-md-5 px-xl-8d75">
        <div
          class="topbar__nav d-md-flex align-items-center justify-content-between"
        >
          <ul class="menu-topbar-left nav ml-md-n3 d-none d-md-flex">
            <li class="topbar-left-item mr-2">
              <a class="nav-link link-black-100">
                <i class="far fa-question-circle mr-2"></i> Can we help you?
              </a>
            </li>
            <li class="topbar-left-item mr-2">
              <a class="nav-link link-black-100">
                <i class="fas fa-mobile-alt mr-2"></i> +1 246-345-0695
              </a>
            </li>
          </ul>
          <div class="menu-topbar-right">
            <ul class="nav justify-content-end">
              ...
              <li class="nav-item d-none d-md-block">
                <router-link
                  class="nav-link link-black-100 font-size-3 px-3 relative"
                  to="#"
                >
                  <div id="cart-contents-count">
                    <span>0</span>
                  </div>
      ...
      <div class="container-fluid px-3 px-md-5 px-xl-8d75 py-2 py-md-0">
        <div class="d-flex align-items-center relative flex-wrap">
          ...
          <div class="site-branding pr-md-4">
            <router-link to="/" class="header-logo-link d-block">
              <svg
          ...
          <div class="site-navigation mr-auto d-none d-xl-block">
            <ul class="primary-menu nav">
              <li class="menu-item">
                <a class="nav-link link-black-100 dropdown-toggle" href="#"
                  >Home</a
                >
              </li>
              <li class="menu-item">
                <a class="nav-link link-black-100" href="#">Categories</a>
              </li>
              <li class="menu-item">
                <a class="nav-link link-black-100 dropdown-toggle" href="#"
                  >Shop</a
          ...
          <div class="site-search w-r-100 ml-md-auto ml-xl-0">
            <form
              method="get"
              id="searchform"
              class="form-inline my-2 my-xl-0"
              action=""
            >
              <b-input-group class="">
                <template #prepend>
                  <b-input-group-text class="bg-white-100 border-0"
                ...
                <b-form-input
                  ...
                  class="search-input bg-white-100 border-0"
                ></b-form-input>
              </b-input-group>
            </form>
          </div>
